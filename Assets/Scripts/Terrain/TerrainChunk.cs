...
public class TerrainChunk
{
    ...
    public TerrainChunk(Vector2 coord, HeightMapSettings heightMapSettings, MeshSettings meshSettings, LODInfo[] detailLevels, int colliderLODIndex, Transform parent, Transform viewer, Material material)
    {
        ...
        edgesData.bottomEdge = (coord.x != 3 && Mathf.Abs(coord.x) <= 3 && Mathf.Abs(coord.y) <= 3);
        edgesData.upperEdge = (coord.x != -3 && Mathf.Abs(coord.x) <= 3 && Mathf.Abs(coord.y) <= 3);
        edgesData.rightEdge = (coord.y != 3 && Mathf.Abs(coord.x) <= 3 && Mathf.Abs(coord.y) <= 3);
        edgesData.leftEdge = (coord.y != -3 && Mathf.Abs(coord.x) <= 3 && Mathf.Abs(coord.y) <= 3);
        // Debug.Log("x: " + coord.x + " y:" + coord.y + " bottomEdge:" + edgesData.bottomEdge + " upperEdge:" + edgesData.upperEdge + " rightEdge:" + edgesData.rightEdge + " leftEdge:" + edgesData.leftEdge);
