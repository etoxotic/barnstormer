...
public class TerrainChunk
{
    ...
    public TerrainChunk(Vector2 coord, HeightMapSettings heightMapSettings, MeshSettings meshSettings, LODInfo[] detailLevels, int colliderLODIndex, Transform parent, Transform viewer, Material material)
    {
        ...
        edgesData.bottomEdge = (coord.x != 1 && coord.x * coord.x + coord.y * coord.y <= 2);
        edgesData.upperEdge = (coord.x != -1 && coord.x * coord.x + coord.y * coord.y <= 2);
        edgesData.rightEdge = (coord.y != 1 && coord.x * coord.x + coord.y * coord.y <= 2);
        edgesData.leftEdge = (coord.y != -1 && coord.x * coord.x + coord.y * coord.y <= 2);
