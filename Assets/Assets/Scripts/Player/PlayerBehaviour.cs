...
namespace Player
{
    public class PlayerBehaviour : MonoBehaviour
    {
        ...
        [SerializeField] private float tailUp; // Компенсация вращательного момента хвоста в вертикольной плоскости
        ...
        private void FixedUpdate()
        {
            ...
            rb.AddTorque((Vector3.Cross(transform.forward, rb.velocity) - transform.right * tailUp).normalized * Mathf.Pow(rb.velocity.magnitude, 2) * tailPower * t, f);
        }
